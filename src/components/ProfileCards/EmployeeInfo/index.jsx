    ...
    <div className={styles.employee__info}>
      ...
      <div className={styles.employee__info__details}>
        <div className={styles.employee__info__design}>
          ...
          <h5 className={`${styles.employee__info__position} ${styles.grey}`}>UI/UX Design Team</h5>
        </div>
        <h3 className={`${styles.employee__info__job__title} ${styles.grey}`}>Web Designer</h3>
        <div className={styles.employee__info__id}>
          <h5 className={styles.employee__info__id__number}>Employee ID : FT - 0001</h5>
          <h5 className={`${styles.employee__info__join__date} ${styles.grey}`}>State of Join : 1st Jan 2023</h5>
        </div>
      </div>
    </div>
  );
